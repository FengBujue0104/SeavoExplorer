...
a = Analysis(
    ...
    hiddenimports=['PyQt5.QtWidgets', 'PyQt5.QtCore', 'PyQt5.QtGui', 'PyQt5.QtSvg', 'PyPDF2', 'openpyxl', 'docx', 'xlrd', 'olefile', 'cv2', 'numpy', 'PIL', 'send2trash.win.modern', 'send2trash.win.IFileOperationProgressSink', 'pythoncom', 'pywintypes', 'win32com.shell.shell', 'win32com.shell.shellcon'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
